...
from verify.verify_trade_alignment import TradeAlignmentVerifier
from verify.verify_filters_and_hft import FilterAndHFTVerifier
...
logger = get_logger("comprehensive_verification", "logs/system/comprehensive_verification.log")
...
class ComprehensiveVerification:
    ...
    def run_full_verification(self, broker_html_file: str = 'TradingHistoryFromBroker.html') -> Dict[str, Any]:
        ...
        try:
            ...
            print(f"  ✓ Reconciliation complete: {recon_results.get('updated_trades', 0)} trades updated")
        ...
        try:
            ...
            print(f"  ✓ Filter/HFT verification complete: {hft_rate:.1f}% sweet spot rate")
        except Exception as e:
        ...
        try:
            ...
            print(f"  ✓ Optimization analysis complete: {suggestions} suggestions generated")
        except Exception as e:
    ...
    def _generate_comprehensive_report(self) -> str:
        ...
        with open(report_file, 'w', encoding='utf-8') as f:
            ...
            if alignment.get('alignment_achieved'):
                f.write("✅ 100% ALIGNMENT ACHIEVED\n")
            else:
                f.write("⚠️  Alignment issues detected\n")
            f.write("\n")
            ...
            if alignment_ok and hft_ok:
                f.write("✅ SYSTEM FULLY OPERATIONAL\n")
    ...
    def run(self):
        ...
        print(f"Trade Alignment: {'✅ 100%' if alignment_ok else '⚠️ Issues'}")
        ...
        if alignment_ok and hft_rate >= 70:
            ...
            print("⚠️  Review report for issues and suggestions")
